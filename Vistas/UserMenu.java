...
public class UserMenu extends javax.swing.JFrame {
    ...
    private void listarEmpleados(){
        ...
        if (filtroBusqueda.isEmpty()) {
            ...
            String queryConsulta = "SELECT `nombreEmp`,`apellidos`,`tipoDocumento`,`documento`,`correo`,"
                    + " `nombreSucursal` FROM `empleado` INNER JOIN sucursal "
                    + "WHERE empleado.FK_idSucursal = sucursal.idSucursal "
                    + "AND `nombreEmp` LIKE '%" + filtroBusqueda + "%' OR `apellidos` "
                    + "LIKE '%" + filtroBusqueda + "%';";
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (departamento.isEmpty() || zona.isEmpty() || tipoCalle.isEmpty() || numero1.isEmpty() || numero2.isEmpty() || numero3.isEmpty() || zona.equals("SeleccionaUnaOpción") || tipoCalle.equals("SeleccionaUnaOpción") || departamento.equals("SeleccionaUnaOpción")) {
            JOptionPane.showMessageDialog(this, "Faltan campos por diligenciar", "", JOptionPane.ERROR_MESSAGE);
        }else{    
        System.out.println("Departamento : " + departamento + "  Zona:  " + zona + "  Tipo de Calle:  " + tipoCalle + "  " + numero1
                + " # " + numero2 + " -- " + numero3);
